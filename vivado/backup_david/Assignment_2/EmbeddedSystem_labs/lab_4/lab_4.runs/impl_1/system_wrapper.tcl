...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab3/lab3.cache/wt [current_project]
  set_property parent.project_path D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab3/lab3.xpr [current_project]
  set_property ip_repo_paths D:/Xilinx/Assignment_2/EmbeddedSystem_labs/led_ip [current_project]
  set_property ip_output_repo D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab3/lab3.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab3/lab3.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab3/lab3.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab3/lab3.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab3/lab3.srcs/constrs_1/imports/lab3/lab3_zybo.xdc
  set_param project.isImplRun true
