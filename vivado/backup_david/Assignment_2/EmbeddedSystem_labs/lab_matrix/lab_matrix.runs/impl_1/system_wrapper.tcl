...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab_matrix/lab_matrix.cache/wt [current_project]
  set_property parent.project_path D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab_matrix/lab_matrix.xpr [current_project]
  set_property ip_repo_paths {
  d:/Xilinx/Assignment_2/EmbeddedSystem_labs/matrix_ip
  D:/Xilinx/Assignment_2/EQ_HLS/HLS/solution1/impl/ip
} [current_project]
  set_property ip_output_repo D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab_matrix/lab_matrix.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab_matrix/lab_matrix.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab_matrix/lab_matrix.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files D:/Xilinx/Assignment_2/EmbeddedSystem_labs/lab_matrix/lab_matrix.srcs/sources_1/bd/system/system.bd]
