...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.eq.autotvin_b0.dat"
         "c.eq.autotvin_b1.dat"
         "c.eq.autotvin_b2.dat"
         "c.eq.autotvin_a1.dat"
         "c.eq.autotvin_a2.dat"
         "c.eq.autotvin_band.dat"
         "c.eq.autotvin_sampleIn.dat"
         "c.eq.autotvout_sampleOut.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.eq.autotvout_sampleOut.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
