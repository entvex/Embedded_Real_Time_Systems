...
(* CORE_GENERATION_INFO="eq,hls_ip_2017_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.912000,HLS_SYN_LAT=27,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=20,HLS_SYN_FF=2193,HLS_SYN_LUT=1175}" *)
...
parameter    C_S_AXI_EQIO_ADDR_WIDTH = 6;
...
assign sampleOut = tmp_12_reg_328;
