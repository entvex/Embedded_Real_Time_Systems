...
$(ObjDir)/EQTest.c_pre.c.tb.o : EQTest.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) EQTest.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/EQFilter.c_pre.c.tb.o : EQFilter.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) EQFilter.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
