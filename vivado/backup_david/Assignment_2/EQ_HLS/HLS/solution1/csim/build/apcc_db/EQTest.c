...
void eq(signed int , signed int , signed int , signed int , signed int , signed short , signed short , signed short *);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  call void @eq(i32 %%16, i32 %%17, i32 %%18, i32 %%19, i32 %%13, i16 signext %%20, i16 signext 0, i16* %%output) nounwind, !dbg !3 for 0x%I64xth hint within @setCoeff  --> \n", ++aesl_llvm_cbe_50_count);
  eq(llvm_cbe_tmp__16, llvm_cbe_tmp__17, llvm_cbe_tmp__18, llvm_cbe_tmp__19, llvm_cbe_tmp__13, llvm_cbe_tmp__20, ((unsigned short )0), (signed short *)(&llvm_cbe_output));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @eq(i32 0, i32 0, i32 0, i32 0, i32 0, i16 signext 7, i16 signext %%storemerge1, i16* %%output) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_86_count);
  eq(0u, 0u, 0u, 0u, 0u, ((unsigned short )7), llvm_cbe_storemerge1, (signed short *)(&llvm_cbe_output));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0u);
printf("\nArgument  = 0x%X",0u);
printf("\nArgument  = 0x%X",0u);
