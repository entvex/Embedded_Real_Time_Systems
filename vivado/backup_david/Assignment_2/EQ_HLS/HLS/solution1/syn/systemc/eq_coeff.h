...
#ifndef __eq_coeff_H__
#define __eq_coeff_H__
...
struct eq_coeff_ram : public sc_core::sc_module {
...
eq_coeff_ram* meminst;


SC_CTOR(eq_coeff) {
meminst = new eq_coeff_ram("eq_coeff_ram");
