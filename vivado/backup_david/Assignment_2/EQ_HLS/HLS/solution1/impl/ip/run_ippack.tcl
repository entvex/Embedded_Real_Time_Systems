...
set Interfaces {
    s_axi_eqio {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_eqio"
        param_prefix "C_S_AXI_EQIO"
        addr_bits "7"
        port_width "AWADDR 7 WDATA 32 WSTRB 4 ARADDR 7 RDATA 32"
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 b0 W 0x0 "Data signal of b0" {{0 32 b0 W 0 "Bit 31 to 0 Data signal of b0"}}} {0x18 b1 W 0x0 "Data signal of b1" {{0 32 b1 W 0 "Bit 31 to 0 Data signal of b1"}}} {0x20 b2 W 0x0 "Data signal of b2" {{0 32 b2 W 0 "Bit 31 to 0 Data signal of b2"}}} {0x28 a1 W 0x0 "Data signal of a1" {{0 32 a1 W 0 "Bit 31 to 0 Data signal of a1"}}} {0x30 a2 W 0x0 "Data signal of a2" {{0 32 a2 W 0 "Bit 31 to 0 Data signal of a2"}}} {0x38 band W 0x0 "Data signal of band" {{0 16 band W 0 "Bit 15 to 0 Data signal of band"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 sampleIn W 0x0 "Data signal of sampleIn" {{0 16 sampleIn W 0 "Bit 15 to 0 Data signal of sampleIn"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 sampleOut R 0x0 "Data signal of sampleOut" {{0 16 sampleOut R 0 "Bit 15 to 0 Data signal of sampleOut"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x4c sampleOut_ctrl R 0x0 "Control signal of sampleOut" {{0 1 sampleOut_ap_vld R 0 "Control signal sampleOut_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 8.000000 machine 64 combinational 0 latency 3 II x}
...
set enable_xo_gen 0
set kernel_files {D:/Xilinx/Assignment_2/EQ_HLS/EQ.c}
if {$enable_xo_gen} {
