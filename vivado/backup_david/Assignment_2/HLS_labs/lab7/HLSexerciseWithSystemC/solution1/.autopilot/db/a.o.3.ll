; ModuleID = 'D:/Xilinx/Assignment_2/HLS_labs/lab7/HLSexerciseWithSystemC/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@ssdm_ins_iosc_0_0_sw = constant i8 0             ; [#uses=0 type=i8*]
@ssdm_ins_iosc_0_0_re = constant i1 false         ; [#uses=0 type=i1*]
@ssdm_ins_iosc_0_0_ou = constant i4 0             ; [#uses=0 type=i4*]
@ssdm_ins_iosc_0_0_in_1 = constant i4 0           ; [#uses=0 type=i4*]
@ssdm_ins_iosc_0_0_in = constant i1 false         ; [#uses=0 type=i1*]
...
@iosc_ssdm_thread_M_pulse = external global i1    ; [#uses=1 type=i1*]
@iosc_ssdm_thread_M_controlOutLeds = external global i1 ; [#uses=1 type=i1*]
@p_str9 = private unnamed_addr constant [15 x i8] c"__ssdm_reset__\00", align 1 ; [#uses=4 type=[15 x i8]*]
@p_str8 = private unnamed_addr constant [15 x i8] c"controlOutLeds\00", align 1 ; [#uses=4 type=[15 x i8]*]
...
@p_str16 = private unnamed_addr constant [6 x i8] c"pulse\00", align 1 ; [#uses=4 type=[6 x i8]*]
...
@p_str12 = private unnamed_addr constant [14 x i8] c"internalPulse\00", align 1 ; [#uses=1 type=[14 x i8]*]
...
; [#uses=1]
define void @"iosc::pulse"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i1* %iosc_internalPulse_Val, i8* %iosc_switchs_V) {
_ZN7_ap_sc_7sc_core4waitEi.exit2:
  %clockCounter_V_1 = alloca i10                  ; [#uses=4 type=i10*]
  call void @llvm.dbg.declare(metadata !{i10* %clockCounter_V_1}, metadata !84) ; [debug variable = clockCounter.V]
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_clk_m_if_Val), !map !2558
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_reset_m_if_Val), !map !2562
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_ctrl_m_if_Val_V), !map !2566
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_inSwitch_m_if_Val_V), !map !2570
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_outLeds_m_if_Val_V), !map !2574
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_internalPulse_Val), !map !2578
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %iosc_switchs_V), !map !2582
  call void @llvm.dbg.value(metadata !{i1* %iosc_clk_m_if_Val}, i64 0, metadata !2586), !dbg !2598 ; [debug line = 42:12] [debug variable = iosc.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %iosc_reset_m_if_Val}, i64 0, metadata !2599), !dbg !2598 ; [debug line = 42:12] [debug variable = iosc.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %iosc_ctrl_m_if_Val_V}, i64 0, metadata !2600), !dbg !2598 ; [debug line = 42:12] [debug variable = iosc.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_inSwitch_m_if_Val_V}, i64 0, metadata !2616), !dbg !2598 ; [debug line = 42:12] [debug variable = iosc.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_outLeds_m_if_Val_V}, i64 0, metadata !2617), !dbg !2598 ; [debug line = 42:12] [debug variable = iosc.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i1* %iosc_internalPulse_Val}, i64 0, metadata !2628), !dbg !2598 ; [debug line = 42:12] [debug variable = iosc.internalPulse.Val]
  call void @llvm.dbg.value(metadata !{i8* %iosc_switchs_V}, i64 0, metadata !2635), !dbg !2598 ; [debug line = 42:12] [debug variable = iosc.switchs.V]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %iosc_clk_m_if_Val) nounwind, !dbg !2645 ; [debug line = 43:4]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %iosc_reset_m_if_Val) nounwind, !dbg !2646 ; [debug line = 44:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %iosc_ctrl_m_if_Val_V) nounwind, !dbg !2647 ; [debug line = 45:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %iosc_inSwitch_m_if_Val_V) nounwind, !dbg !2648 ; [debug line = 46:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %iosc_outLeds_m_if_Val_V) nounwind, !dbg !2649 ; [debug line = 47:3]
  call void (...)* @_ssdm_op_SpecProcessDef([5 x i8]* @p_str, i32 2, [6 x i8]* @p_str16) nounwind, !dbg !2650 ; [debug line = 48:3]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !2651 ; [#uses=1 type=i32] [debug line = 48:101]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !2652 ; [debug line = 48:185]
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !2653 ; [#uses=1 type=i32] [debug line = 48:235]
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !2654), !dbg !2653 ; [debug line = 48:235] [debug variable = _ssdm_reset_v]
  call void @llvm.dbg.value(metadata !{i1* %iosc_internalPulse_Val}, i64 0, metadata !2655), !dbg !2662 ; [debug line = 128:96@207:13@44:1] [debug variable = P]
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %iosc_internalPulse_Val, i1 false), !dbg !2671 ; [debug line = 167:116@207:13@44:1]
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !2674 ; [#uses=0 type=i32] [debug line = 44:29]
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_1), !dbg !2675 ; [#uses=0 type=i32] [debug line = 44:67]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2676 ; [debug line = 803:19@45:1]
  store i10 0, i10* %clockCounter_V_1
  br label %0, !dbg !2683                         ; [debug line = 46:5]

; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %clockCounter_V_1_loa = load i10* %clockCounter_V_1, !dbg !2684 ; [#uses=2 type=i10] [debug line = 1824:147@1854:9@55:4]
  %tmp = icmp ugt i10 %clockCounter_V_1_loa, -24, !dbg !2944 ; [#uses=1 type=i1] [debug line = 1995:9@3575:143@50:7]
  br i1 %tmp, label %1, label %2, !dbg !2955      ; [debug line = 50:7]

; <label>:1                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i1* %iosc_internalPulse_Val}, i64 0, metadata !2655), !dbg !2956 ; [debug line = 128:96@207:13@53:4] [debug variable = P]
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %iosc_internalPulse_Val, i1 true), !dbg !2960 ; [debug line = 167:116@207:13@53:4]
  store i10 0, i10* %clockCounter_V_1
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !2961 ; [debug line = 54:3]

; <label>:2                                       ; preds = %0
  %clockCounter_V = add i10 %clockCounter_V_1_loa, 1, !dbg !2684 ; [#uses=1 type=i10] [debug line = 1824:147@1854:9@55:4]
  call void @llvm.dbg.value(metadata !{i10 %clockCounter_V}, i64 0, metadata !84), !dbg !2684 ; [debug line = 1824:147@1854:9@55:4] [debug variable = clockCounter.V]
  call void @llvm.dbg.value(metadata !{i1* %iosc_internalPulse_Val}, i64 0, metadata !2655), !dbg !2962 ; [debug line = 128:96@207:13@56:4] [debug variable = P]
  call void @_ssdm_op_Write.ap_auto.volatile.i1P(i1* %iosc_internalPulse_Val, i1 false), !dbg !2965 ; [debug line = 167:116@207:13@56:4]
  store i10 %clockCounter_V, i10* %clockCounter_V_1, !dbg !2684 ; [debug line = 1824:147@1854:9@55:4]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %2, %1
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2966 ; [debug line = 803:19@58:3]
  br label %0, !dbg !2968                         ; [debug line = 59:2]
}

; [#uses=0]
define weak void @"iosc::iosc"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i1* %iosc_internalPulse_Val, i8* %iosc_switchs_V) {
  call void (...)* @_ssdm_op_SpecIFCore(i4* %iosc_ctrl_m_if_Val_V, [1 x i8]* @p_str10, [10 x i8]* @p_str14, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str15)
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_clk_m_if_Val), !map !2558
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_reset_m_if_Val), !map !2562
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_ctrl_m_if_Val_V), !map !2566
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_internalPulse_Val), !map !2578
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %iosc_switchs_V), !map !2582
  call void @llvm.dbg.value(metadata !{i1* %iosc_clk_m_if_Val}, i64 0, metadata !2969), !dbg !2972 ; [debug line = 18:3] [debug variable = iosc.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %iosc_reset_m_if_Val}, i64 0, metadata !2973), !dbg !2972 ; [debug line = 18:3] [debug variable = iosc.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %iosc_ctrl_m_if_Val_V}, i64 0, metadata !2974), !dbg !2972 ; [debug line = 18:3] [debug variable = iosc.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_inSwitch_m_if_Val_V}, i64 0, metadata !2975), !dbg !2972 ; [debug line = 18:3] [debug variable = iosc.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_outLeds_m_if_Val_V}, i64 0, metadata !2976), !dbg !2972 ; [debug line = 18:3] [debug variable = iosc.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i1* %iosc_internalPulse_Val}, i64 0, metadata !2977), !dbg !2972 ; [debug line = 18:3] [debug variable = iosc.internalPulse.Val]
  call void @llvm.dbg.value(metadata !{i8* %iosc_switchs_V}, i64 0, metadata !2978), !dbg !2972 ; [debug line = 18:3] [debug variable = iosc.switchs.V]
  call void (...)* @_ssdm_op_SpecTopModule([5 x i8]* @p_str, [5 x i8]* @p_str) nounwind, !dbg !2979 ; [debug line = 20:5]
  %iosc_ssdm_thread_s = load i1* @iosc_ssdm_thread_M_controlOutLeds, align 1, !dbg !2981 ; [#uses=1 type=i1] [debug line = 21:5]
  br i1 %iosc_ssdm_thread_s, label %1, label %2, !dbg !2981 ; [debug line = 21:5]

; <label>:1                                       ; preds = %0
  call void @"iosc::controlOutLeds"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i1* %iosc_internalPulse_Val, i8* %iosc_switchs_V), !dbg !2982 ; [debug line = 21:41]
  br label %UnifiedUnreachableBlock

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecProcessDecl([5 x i8]* @p_str, i32 2, [15 x i8]* @p_str8) nounwind, !dbg !2983 ; [debug line = 21:59]
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str8, [4 x i8]* @p_str2, i1* %iosc_clk_m_if_Val, i32 1) nounwind, !dbg !2984 ; [debug line = 22:5]
  call void (...)* @_ssdm_op_SpecSensitive([15 x i8]* @p_str8, [6 x i8]* @p_str3, i1* %iosc_reset_m_if_Val, i32 3) nounwind, !dbg !2985 ; [debug line = 23:5]
  %iosc_ssdm_thread_1 = load i1* @iosc_ssdm_thread_M_pulse, align 1, !dbg !2986 ; [#uses=1 type=i1] [debug line = 24:5]
  br i1 %iosc_ssdm_thread_1, label %3, label %4, !dbg !2986 ; [debug line = 24:5]

; <label>:3                                       ; preds = %2
  call void @"iosc::pulse"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i1* %iosc_internalPulse_Val, i8* %iosc_switchs_V), !dbg !2987 ; [debug line = 24:32]
  br label %UnifiedUnreachableBlock

; <label>:4                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecProcessDecl([5 x i8]* @p_str, i32 2, [6 x i8]* @p_str16) nounwind, !dbg !2988 ; [debug line = 24:41]
  call void (...)* @_ssdm_op_SpecSensitive([6 x i8]* @p_str16, [4 x i8]* @p_str2, i1* %iosc_clk_m_if_Val, i32 1) nounwind, !dbg !2989 ; [debug line = 25:5]
  call void (...)* @_ssdm_op_SpecSensitive([6 x i8]* @p_str16, [6 x i8]* @p_str3, i1* %iosc_reset_m_if_Val, i32 3) nounwind, !dbg !2990 ; [debug line = 26:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %iosc_clk_m_if_Val) nounwind, !dbg !2991 ; [debug line = 27:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %iosc_reset_m_if_Val) nounwind, !dbg !2992 ; [debug line = 28:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %iosc_ctrl_m_if_Val_V) nounwind, !dbg !2993 ; [debug line = 29:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %iosc_inSwitch_m_if_Val_V) nounwind, !dbg !2994 ; [debug line = 30:5]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %iosc_outLeds_m_if_Val_V) nounwind, !dbg !2995 ; [debug line = 31:5]
  call void (...)* @_ssdm_op_SpecChannel([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [14 x i8]* @p_str12, i32 1, i32 0, i1* %iosc_internalPulse_Val) nounwind, !dbg !2996 ; [debug line = 32:5]
  ret void, !dbg !2997                            ; [debug line = 34:1]
...
; [#uses=1]
define void @"iosc::controlOutLeds"(i1* %iosc_clk_m_if_Val, i1* %iosc_reset_m_if_Val, i4* %iosc_ctrl_m_if_Val_V, i4* %iosc_inSwitch_m_if_Val_V, i4* %iosc_outLeds_m_if_Val_V, i1* %iosc_internalPulse_Val, i8* %iosc_switchs_V) {
_ZN7_ap_sc_7sc_core4waitEi.exit:
  %v_assign = alloca i32                          ; [#uses=4 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %v_assign}, metadata !2998) ; [debug variable = op]
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_clk_m_if_Val), !map !2558
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_reset_m_if_Val), !map !2562
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_ctrl_m_if_Val_V), !map !2566
  call void (...)* @_ssdm_op_SpecBitsMap(i4* %iosc_inSwitch_m_if_Val_V), !map !2570
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i1* %iosc_internalPulse_Val), !map !2578
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %iosc_switchs_V), !map !2582
  call void @llvm.dbg.value(metadata !{i1* %iosc_clk_m_if_Val}, i64 0, metadata !3000), !dbg !3003 ; [debug line = 4:12] [debug variable = iosc.clk.m_if.Val]
  call void @llvm.dbg.value(metadata !{i1* %iosc_reset_m_if_Val}, i64 0, metadata !3004), !dbg !3003 ; [debug line = 4:12] [debug variable = iosc.reset.m_if.Val]
  call void @llvm.dbg.value(metadata !{i4* %iosc_ctrl_m_if_Val_V}, i64 0, metadata !3005), !dbg !3003 ; [debug line = 4:12] [debug variable = iosc.ctrl.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_inSwitch_m_if_Val_V}, i64 0, metadata !3006), !dbg !3003 ; [debug line = 4:12] [debug variable = iosc.inSwitch.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i4* %iosc_outLeds_m_if_Val_V}, i64 0, metadata !3007), !dbg !3003 ; [debug line = 4:12] [debug variable = iosc.outLeds.m_if.Val.V]
  call void @llvm.dbg.value(metadata !{i1* %iosc_internalPulse_Val}, i64 0, metadata !3008), !dbg !3003 ; [debug line = 4:12] [debug variable = iosc.internalPulse.Val]
  call void @llvm.dbg.value(metadata !{i8* %iosc_switchs_V}, i64 0, metadata !3009), !dbg !3003 ; [debug line = 4:12] [debug variable = iosc.switchs.V]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [4 x i8]* @p_str2, i32 0, i32 0, i1* %iosc_clk_m_if_Val) nounwind, !dbg !3010 ; [debug line = 5:4]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [7 x i8]* @p_str1, [6 x i8]* @p_str3, i32 0, i32 0, i1* %iosc_reset_m_if_Val) nounwind, !dbg !3012 ; [debug line = 6:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [5 x i8]* @p_str5, i32 0, i32 0, i4* %iosc_ctrl_m_if_Val_V) nounwind, !dbg !3013 ; [debug line = 7:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 0, [13 x i8]* @p_str4, [9 x i8]* @p_str6, i32 0, i32 0, i4* %iosc_inSwitch_m_if_Val_V) nounwind, !dbg !3014 ; [debug line = 8:3]
  call void (...)* @_ssdm_op_SpecPort([5 x i8]* @p_str, i32 1, [13 x i8]* @p_str4, [8 x i8]* @p_str7, i32 0, i32 0, i4* %iosc_outLeds_m_if_Val_V) nounwind, !dbg !3015 ; [debug line = 9:3]
  call void (...)* @_ssdm_op_SpecProcessDef([5 x i8]* @p_str, i32 2, [15 x i8]* @p_str8) nounwind, !dbg !3016 ; [debug line = 10:3]
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str9), !dbg !3017 ; [#uses=1 type=i32] [debug line = 10:110]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @p_str10) nounwind, !dbg !3018 ; [debug line = 10:194]
  %p_ssdm_reset_v = call i32 (...)* @_ssdm_op_SpecStateBegin(i32 0, i32 0, i32 1) nounwind, !dbg !3019 ; [#uses=1 type=i32] [debug line = 10:244]
  call void @llvm.dbg.value(metadata !{i32 %p_ssdm_reset_v}, i64 0, metadata !3020), !dbg !3019 ; [debug line = 10:244] [debug variable = _ssdm_reset_v]
  call void (...)* @_ssdm_op_SpecIFCore(i4* %iosc_ctrl_m_if_Val_V, [1 x i8]* @p_str10, [10 x i8]* @p_str14, [1 x i8]* @p_str10, i32 -1, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [1 x i8]* @p_str10, [17 x i8]* @p_str15), !dbg !3021 ; [debug line = 6:1]
  %empty = call i32 (...)* @_ssdm_op_SpecStateEnd(i32 %p_ssdm_reset_v) nounwind, !dbg !3022 ; [#uses=0 type=i32] [debug line = 7:27]
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str9, i32 %tmp_2), !dbg !3023 ; [#uses=0 type=i32] [debug line = 7:65]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !3024 ; [debug line = 803:19@8:1]
  store i32 0, i32* %v_assign
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2, !dbg !3026 ; [debug line = 9:5]

_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, %_ZN7_ap_sc_7sc_core4waitEi.exit
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !3027 ; [debug line = 803:19@11:3]
  %val_V = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %iosc_ctrl_m_if_Val_V), !dbg !3030 ; [#uses=2 type=i4] [debug line = 374:13@60:21@180:66@351:73@13:14]
  call void @llvm.dbg.value(metadata !{i4 %val_V}, i64 0, metadata !3048), !dbg !3030 ; [debug line = 374:13@60:21@180:66@351:73@13:14] [debug variable = val.V]
  switch i4 %val_V, label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge [
    ...
    i4 -2, label %_ZN7_ap_sc_7sc_core4waitEi.exit2._crit_edge150
    i4 -1, label %_ZN7_ap_sc_7sc_core4waitEi.exit2._crit_edge150
  ], !dbg !3050                                   ; [debug line = 15:2]

; <label>:0                                       ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %val_V_1 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %iosc_inSwitch_m_if_Val_V), !dbg !3051 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@18:8]
  call void @llvm.dbg.value(metadata !{i4 %val_V_1}, i64 0, metadata !3048), !dbg !3051 ; [debug line = 374:13@60:21@180:66@351:73@18:8] [debug variable = val.V]
  %tmp = icmp eq i4 %val_V_1, -8, !dbg !3057      ; [#uses=1 type=i1] [debug line = 1979:9@3571:144@18:8]
  br i1 %tmp, label %1, label %2, !dbg !3055      ; [debug line = 18:8]

; <label>:1                                       ; preds = %0
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %iosc_outLeds_m_if_Val_V, i4 0), !dbg !3068 ; [debug line = 365:13@56:100@207:13@427:73@21:5]
  store i32 0, i32* %v_assign
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, !dbg !3090 ; [debug line = 22:4]

; <label>:2                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i1* %iosc_internalPulse_Val}, i64 0, metadata !3091), !dbg !3097 ; [debug line = 166:90@180:66@25:8] [debug variable = P]
  %tmp_1 = call i1 @_ssdm_op_Read.ap_auto.volatile.i1P(i1* %iosc_internalPulse_Val), !dbg !3103 ; [#uses=1 type=i1] [debug line = 166:95@180:66@25:8]
  call void @llvm.dbg.value(metadata !{i1 %tmp_1}, i64 0, metadata !3105), !dbg !3098 ; [debug line = 180:66@25:8] [debug variable = tmp]
  br i1 %tmp_1, label %3, label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, !dbg !3101 ; [debug line = 25:8]

; <label>:3                                       ; preds = %2
  %v_assign_load = load i32* %v_assign, !dbg !3106 ; [#uses=2 type=i32] [debug line = 27:6]
  %internalLEDValue = add nsw i32 1, %v_assign_load, !dbg !3106 ; [#uses=1 type=i32] [debug line = 27:6]
  call void @llvm.dbg.value(metadata !{i32 %internalLEDValue}, i64 0, metadata !3108), !dbg !3106 ; [debug line = 27:6] [debug variable = internalLEDValue]
  %v_V_1 = trunc i32 %v_assign_load to i4, !dbg !3109 ; [#uses=1 type=i4] [debug line = 1456:74@343:80@343:82@27:6]
  call void @llvm.dbg.value(metadata !{i4 %v_V_1}, i64 0, metadata !3115), !dbg !3117 ; [debug line = 206:21@427:73@27:6] [debug variable = v.V]
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %iosc_outLeds_m_if_Val_V, i4 %v_V_1), !dbg !3119 ; [debug line = 365:13@56:100@207:13@427:73@27:6]
  store i32 %internalLEDValue, i32* %v_assign, !dbg !3106 ; [debug line = 27:6]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, !dbg !3122 ; [debug line = 28:5]
...
_ZN7_ap_sc_7sc_core4waitEi.exit2._crit_edge150:   ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2, %_ZN7_ap_sc_7sc_core4waitEi.exit2
  %val_V_2 = call i4 @_ssdm_op_Read.ap_auto.volatile.i4P(i4* %iosc_inSwitch_m_if_Val_V), !dbg !3123 ; [#uses=1 type=i4] [debug line = 374:13@60:21@180:66@351:73@33:26]
  call void @llvm.dbg.value(metadata !{i4 %val_V_2}, i64 0, metadata !3048), !dbg !3123 ; [debug line = 374:13@60:21@180:66@351:73@33:26] [debug variable = val.V]
  %v_V = and i4 %val_V_2, %val_V, !dbg !3128      ; [#uses=1 type=i4] [debug line = 3374:0@3568:204@33:26]
  call void @llvm.dbg.value(metadata !{i4 %v_V}, i64 0, metadata !3115), !dbg !3143 ; [debug line = 206:21@427:73@33:26] [debug variable = v.V]
  call void @_ssdm_op_Write.ap_auto.volatile.i4P(i4* %iosc_outLeds_m_if_Val_V, i4 %v_V), !dbg !3145 ; [debug line = 365:13@56:100@207:13@427:73@33:26]
  br label %_ZN7_ap_sc_7sc_core4waitEi.exit2.backedge, !dbg !3148 ; [debug line = 34:4]
