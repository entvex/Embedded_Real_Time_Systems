; ModuleID = 'D:/Xilinx/Assignment_2/HLS_labs/lab4/fir.prj/solution1/.autopilot/db/a.o.2.bc'
...
define void @fir(i16* %y, i16 signext %x) nounwind {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i16* %y, [10 x i8]* @.str, i32 1, i32 1, [1 x i8]* @.str1, i32 0, i32 0, [7 x i8]* @.str2, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !45 ; [debug line = 7:1]
...
!7 = metadata !{i32 786449, i32 0, i32 1, metadata !"D:/Xilinx/Assignment_2/HLS_labs/lab4/fir.prj/solution1/.autopilot/db/fir.pragma.2.c", metadata !"D:\5CXilinx\5CAssignment_2\5CHLS_labs\5Clab4", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, null, null, null, metadata !8} ; [ DW_TAG_compile_unit ]
!8 = metadata !{metadata !9}
!9 = metadata !{metadata !10, metadata !23}
!10 = metadata !{i32 786484, i32 0, metadata !11, metadata !"shift_reg", metadata !"shift_reg", metadata !"", metadata !12, i32 12, metadata !20, i32 1, i32 1, [58 x i16]* @shift_reg} ; [ DW_TAG_variable ]
...
!12 = metadata !{i32 786473, metadata !"fir.c", metadata !"D:\5CXilinx\5CAssignment_2\5CHLS_labs\5Clab4", null} ; [ DW_TAG_file_type ]
...
!20 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 928, i64 16, i32 0, i32 0, metadata !16, metadata !21, i32 0, i32 0} ; [ DW_TAG_array_type ]
!21 = metadata !{metadata !22}
!22 = metadata !{i32 786465, i64 0, i64 57}       ; [ DW_TAG_subrange_type ]
!23 = metadata !{i32 786484, i32 0, metadata !11, metadata !"c", metadata !"c", metadata !"", metadata !12, i32 7, metadata !24, i32 1, i32 1, [59 x i16]* @c} ; [ DW_TAG_variable ]
!24 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 944, i64 16, i32 0, i32 0, metadata !25, metadata !27, i32 0, i32 0} ; [ DW_TAG_array_type ]
!25 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !26} ; [ DW_TAG_const_type ]
!26 = metadata !{i32 786454, null, metadata !"coef_t", metadata !12, i32 6, i64 0, i64 0, i64 0, i32 0, metadata !17} ; [ DW_TAG_typedef ]
!27 = metadata !{metadata !28}
!28 = metadata !{i32 786465, i64 0, i64 58}       ; [ DW_TAG_subrange_type ]
