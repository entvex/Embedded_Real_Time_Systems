; ModuleID = 'D:/Xilinx/Assignment_2/HLS_labs/lab4/fir.prj/solution1/.autopilot/db/a.o.3.bc'
...
define void @fir(i16* %y, i16 signext %x) nounwind {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i16* %y, [10 x i8]* @p_str, i32 1, i32 1, [1 x i8]* @p_str1, i32 0, i32 0, [7 x i8]* @p_str2, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !32 ; [debug line = 7:1]
...
!21 = metadata !{i32 786473, metadata !"fir.c", metadata !"D:\5CXilinx\5CAssignment_2\5CHLS_labs\5Clab4", null} ; [ DW_TAG_file_type ]
