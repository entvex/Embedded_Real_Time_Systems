...
void AESL_WRAP_fir(signed short *, signed short );
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str1, i32 0, i32 0)) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = select i1 %%3, i16 -32768, i16 0, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AESL_WRAP_fir(i16* %%output, i16 signext %%storemerge1) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_15_count);
  AESL_WRAP_fir((signed short *)(&llvm_cbe_output), llvm_cbe_storemerge1);
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @aesl_internal_.str2, i32 0, i32 0), i32 %%storemerge2, i32 %%4, i32 %%6) nounwind, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_25_count);
