...
HD_PWD='D:/Xilinx/Assignment_2/HLS_labs/lab4/audio/audio.runs/system_zybo_audio_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_zybo_audio_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_zybo_audio_ctrl_0_0.tcl
